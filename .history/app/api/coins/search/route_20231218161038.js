...
console.log(request.url)
 ...
 const filteredCoins = coins.data.coins.filter((coins) => {
    return coins.name.toLowerCase().includes(query.toLowerCase()) || coins.symbol.toLowerCase().includes(query.toLowerCase())
 })
return NextResponse.
}
